...
Most interessant feature is the introduction of [PHPCrypt library](https://github.com/gilfether/phpcrypt) which now used in order to handle all database data encryption.
The complete related documentation is available in the author's webpage.
This permits to get rid of `keys` table.
